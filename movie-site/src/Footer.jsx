export default function Footer() {
    return (
        <footer className="mt-auto text-center text-white text-sm py-4 flex flex-col items-center space-y-2">
            <p>
            ...
            <div className="flex space-x-4">
                ...
                <a
                    ...
                    className="hover:text-yellow-500 transition relative group"
                    >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-7" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="absolute -top-8 left-1/2 transform -translate-x-1/2 
                                    bg-white text-black text-s rounded px-2 py-1 
